...
public class LoginDialog extends javax.swing.JDialog {
    ...
    public boolean authenticate(String user, String password) {
        ...
        String query = "SELECT id FROM Users WHERE name = '" + user + "' and password = '" + password + "';";
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(passwordTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 139, Short.MAX_VALUE))))
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        if (this.isLoggedIn) {
            SoapClientGUI client = new SoapClientGUI(this.userID);
